...
export default function DeleteBookingButton({ bookingId }: { bookingId: string }) {
  const [state, action, pending] = useActionState<State, FormData>(deleteBooking, undefined)
      ...
      >
        <div className="rounded-xl border border-red-200 bg-red-50 p-4 space-y-3">
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <p className="text-sm font-semibold text-red-800">Delete this booking?</p>
              <p className="text-xs text-red-600 mt-0.5 leading-relaxed">
                This permanently removes the booking and all assignments. It cannot be undone.
              </p>
            </div>
          </div>
