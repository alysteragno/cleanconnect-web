...
// Shows every cleaner's most recent known location as a pin on one map:
// profiles.last_seen_lat/lng (an opportunistic ping from the mobile app, not
// continuous tracking) when present, otherwise the admin-set home address as
// a fallback — same source chain the AI dispatcher uses (src/lib/ai-assignment.ts).
export default function CleanersLocationMap({ cleaners }: { cleaners: CleanerLocation[] }) {
