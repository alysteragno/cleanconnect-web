...
// Archive / restore control for a complaint. Archiving asks for confirmation
// (it removes the complaint from the active list) but never deletes any data —
// the thread stays fully readable and can be restored at any time.
export default function ArchiveComplaintButton({
  complaintId,
  archived,
}: {
  complaintId: string
