...
import { deleteCustomerAccount } from '@/app/actions/admin'

type State = { error?: string } | undefined

export default function DeleteCustomerButton({ customerId }: { customerId: string }) {
  const [state, action, pending] = useActionState<State, FormData>(deleteCustomerAccount, undefined)
      ...
      >
        <div className="rounded-xl border border-red-200 bg-red-50 p-4 space-y-3">
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <p className="text-sm font-semibold text-red-800">Delete this customer account?</p>
              <p className="text-xs text-red-600 mt-0.5 leading-relaxed">
                This immediately revokes their login and permanently erases their entire booking
                history, including all payment records. This cannot be undone — consider whether
                Deactivate is enough before proceeding.
              </p>
            </div>
          </div>
