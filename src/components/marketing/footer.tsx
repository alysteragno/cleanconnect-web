        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              <a href={CONTACT.phoneTel} className="flex items-center gap-2 text-sm text-gray-500 hover:text-pink-600 transition-colors">
              ...
              <a href={`mailto:${CONTACT.email}`} className="flex items-center gap-2 text-sm text-gray-500 hover:text-pink-600 transition-colors">
                <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
              ...
              <a href={CONTACT.messengerUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-500 hover:text-pink-600 transition-colors">
                <Image src="/messenger-fill.svg" alt="" width={14} height={14} className="shrink-0 opacity-60" />
                Facebook Messenger
              </a>
              <a href={CONTACT.whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-500 hover:text-pink-600 transition-colors">
