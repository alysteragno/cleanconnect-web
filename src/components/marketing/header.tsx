              ...
              {NAV_LINKS.map((link) => (
                <Link
                  ...
                  className={pathname === link.href
                    ? 'text-xs font-semibold uppercase tracking-widest text-gray-900'
                    : 'text-xs font-medium uppercase tracking-widest text-gray-500 hover:text-gray-900 transition-colors'}
                >
                  {link.label}
                </Link>
              ))}
