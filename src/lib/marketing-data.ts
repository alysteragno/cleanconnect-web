...
export const STEPS = [
  {
    step: '01',
    title: 'Book Online',
    description: 'Enter your address and property details. Get an instant price estimate powered by our pricing engine.',
  },
  {
    step: '02',
  ...
  },
  {
    ...
    description: "Your cleaner arrives, completes the job, and you rate the service when it's done.",
  },
]
